...
namespace TCPIPServer
{
    public partial class ServerForm : Form
    {
        ...
        private void CleanupDeadClient(int clientNumber)
        {
            ...
            {
                throw new Exception("CleanupDeadClient");
            }
            ...
            catch { throw new Exception("CleanupDeadClient"); }
        ...
        private void SetNewConnectionData_FromThread(int clientNumber)
        {
            ...
            try
            {
                lock (svr.workerSockets)
                {
                    ...
                    li.Name = clientNumber.ToString();
                    li.Tag = clientNumber;

                    listView1.Items.Add(li);
                    li.SubItems.Add("Receiving...");
                    li.SubItems.Add("Receiving...");
                    li.SubItems.Add(clientNumber.ToString());
                    li.SubItems.Add("Receiving...");
                    li.SubItems.Add("...");
            ...
            while (svr.IsListening)
            {
                ...
                try
                {
                    while (FullPacketList.Count > 0)
                    {
                        ...
                        string s = fp.iFromClient.ToString();
        ...
        #endregion
        private static string packetAsString;

        public static string PacketAsString
        {
            get { return packetAsString; }
            set { packetAsString = value; }
        }
        ...
        private void SetHostNameAndAddress()
        {
            ...
            string.Format("{0} | {1} | {2}", this.Text, Environment.UserDomainName, Properties.Settings.Default.Port,
            Properties.Settings.Default.ServerIP);

            IPAddress[] ips = Dns.GetHostAddresses(Properties.Settings.Default.Port);//.GetValue(0).ToString();
